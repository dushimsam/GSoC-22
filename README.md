...
I am **Samuel Dushimimana**, a graduate from the first cohort in Software Engineering and Embedded Systems at [**Rwanda Coding Academy**](http://rca.ac.rw/) with more than 4 years of experience in building full stack applications. I'm so excited to be a part of FOSSology community in Google Summer of Code 2022.
...
**Pull request:** - [feat(API): delete user group](https://github.com/fossology/fossology/pull/2244)
